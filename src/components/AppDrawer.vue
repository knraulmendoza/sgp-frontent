<template>
    <div>
        <v-app-bar absolute app color="transparent" flat height="60">
            <v-app-bar-nav-icon
                v-if="!drawer"
...
export default class AppDrawer extends Vue {
    ...
    public links = [
        ...
        {
            name: '/actualizacionPresupuestoProyecto',
            icon: 'mdi-format-vertical-align-center',
            text: 'Actualizacion Presupuesto de Proyectos'
        },
        { name: '/ActualizacionPresupuesto', icon: 'book', text: 'Emitir CDP' },
        {
            name: '/registrarGasto',
